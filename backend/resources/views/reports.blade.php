...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-slate-800/50 backdrop-blur-lg border border-gray-200 dark:border-slate-700 rounded-xl p-6 hover:border-purple-500/50 transition-all duration-300">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white mb-6">Summary Statistics</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="bg-gray-50 dark:bg-slate-700/50 p-4 rounded-lg border border-gray-200 dark:border-slate-600">
                    ...
                    <p class="text-3xl font-bold text-slate-900 dark:text-white mt-2">{{ $totalTransactions }}</p>
                </div>
                <div class="bg-gray-50 dark:bg-slate-700/50 p-4 rounded-lg border border-gray-200 dark:border-slate-600">
                    <h3 class="text-sm font-medium text-slate-600 dark:text-slate-300">Fraudulent</h3>
                    <p class="text-3xl font-bold text-red-400 mt-2">{{ $fraudulentTransactions }}</p>
                </div>
                <div class="bg-gray-50 dark:bg-slate-700/50 p-4 rounded-lg border border-gray-200 dark:border-slate-600">
                    <h3 class="text-sm font-medium text-slate-600 dark:text-slate-300">Legitimate</h3>
                    <p class="text-3xl font-bold text-green-400 mt-2">{{ $legitimateTransactions }}</p>
                </div>
                <div class="bg-gray-50 dark:bg-slate-700/50 p-4 rounded-lg border border-gray-200 dark:border-slate-600">
                    <h3 class="text-sm font-medium text-slate-600 dark:text-slate-300">Fraud Rate</h3>
        ...
        <div class="bg-white dark:bg-slate-800/50 backdrop-blur-lg border border-gray-200 dark:border-slate-700 rounded-xl p-6 hover:border-purple-500/50 transition-all duration-300">
            <h2 class="text-xl font-semibold text-slate-900 dark:text-white mb-6">Daily Transaction Report (Last 7 Days)</h2>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                    <thead class="bg-gray-50 dark:bg-slate-700/50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-300 uppercase tracking-wider">Total</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-300 uppercase tracking-wider">Fraudulent</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-300 uppercase tracking-wider">Fraud Rate</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white dark:bg-slate-800/30 divide-y divide-gray-200 dark:divide-slate-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-900 dark:text-white">{{ $item->date }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600 dark:text-slate-300">{{ $item->count }}</td>
